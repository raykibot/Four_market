...
public class RaffleActivityService extends AbstractRaffleActivity implements ISkuStock{
    ...
    public RaffleActivityService(DefaultActionChainFactory defaultActionChainFactory, IActivityRepository activityRepository) {
        super(defaultActionChainFactory, activityRepository);
    }

    @Override
    protected CreateAggregateOrder buildAggregateOrder(SkuRechargeEntity skuRechargeEntity, ActivitySkuEntity activitySkuEntity, ActivityEntity activityEntity, ActivityCountEntity activityCountEntity) {
        ...
        return CreateAggregateOrder.builder()
    ...
    @Override
    protected void doSaveOrder(CreateAggregateOrder createAggregateOrder) {
        activityRepository.doSaveOrder(createAggregateOrder);
    }
